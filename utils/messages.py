...
RM_INDEX_NOT_IN_QUEUE =     EMOJI_RED_CROSS + " There's nothing under index _{index}_. Consult the queue with the command '/queue'"
...
INSERT_INDEX_OUT_OF_BOUNDS =    EMOJI_RED_CROSS + " Index '_{index}_' is outside of the queue. Please insert a vailid row number."
